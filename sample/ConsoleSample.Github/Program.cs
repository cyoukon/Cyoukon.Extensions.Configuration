...
configurationManager.AddGithubConfiguration();
...
Console.WriteLine("=== Github Configuration Sample ===");
Console.WriteLine();
...
{
    if (!item.Key.StartsWith("GithubConfiguration", StringComparison.OrdinalIgnoreCase))
    {

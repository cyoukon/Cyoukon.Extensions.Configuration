...
public class GiteeConfigurationProviderTests
{
    ...
    {
        var provider = new GiteeConfigurationProvider(_mockApiClient.Object, _options, null);
    ...
    public void Constructor_WithEncryptionService_InitializesCorrectly()
    {
        ...
        var provider = new GiteeConfigurationProvider(_mockApiClient.Object, options, encryptionService);
        provider.Should().NotBeNull();
    }
    ...
    public void Load_WithValidFileContent_LoadsConfiguration()
    {
        ...
        var fileContent = new GiteeFileContent
        {
    ...
    public void Load_WithNullFileContent_SetsEmptyData()
    {
        _mockApiClient
            .Setup(x => x.GetFileContentAsync(It.IsAny<string>(), default))
            .ReturnsAsync((GiteeFileContent?)null);
    ...
    public void Load_WithException_SetsError()
    {
        ...
        error.Should().Contain("Failed to load configuration from Gitee");
    }
    ...
    public async Task SaveAsync_WithValidData_ReturnsTrue()
    {
        ...
        var commitResponse = new GiteeCommitResponse
        {
            Content = new GiteeFileContent { Sha = "new-sha" }
        };
    ...
    public async Task SaveAsync_WithNullResponse_ReturnsFalse()
    {
        ...
        _mockApiClient
            .Setup(x => x.CreateOrUpdateFileAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string?>(), default))
            .ReturnsAsync((GiteeCommitResponse?)null);
